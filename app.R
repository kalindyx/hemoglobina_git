                 ...
                 tabPanel("Barplot",
                          sidebarLayout(
                            ...
                            mainPanel(textOutput("selected_sexo1"),
                                      plotOutput("plot5"),))),
                 tabPanel("Curva de Distribuição",
                          sidebarLayout(
                            sidebarPanel(
                              selectInput("sexo", h5("Definir sexo(s) a visualizar:"),choices = list ("Masculino" = "M", "Feminino" = "F"), multiple = TRUE),
                              selectInput("desporto", label = h5("Definir desporto(s) a visualizar:"),
                                          choices = list ("Netball"="Netball", 
                                                          "Gym" = "Gym",
                                                          "BBall" = "BBall",
                                                          "Tennis" = "Tennis", 
                                                          "Rowing" = "Rowing",
                                                          ...
                                                          "TSprnt"= "TSprnt",
                                                          "Field" = "Field",
                                                          "WPolo" = "WPolo"), multiple = TRUE),
                              selectInput("variável", 
                                          h5("Variável em estudo:"),
                                          choices = list ("Massa Magra" = "LBM",
                                                          "Altura" = "Ht",
                                                          "Peso" = "WT",
                                                          "Indice de Massa Corporal" = "BMI",
                                                          "SSF" = "SSF",
                                                          "Contagem de eritrocitos" = "RBC",
                                                          "Contagem de leucocitos" = "WBC",
                                                          "Percentagem de hematocrito" = "HCT",
                                                          "Concentracao de hemoglobina" = "HGB",
                                                          "Quantidade de Ferritinas Plasmaticas" = "Ferr",
                                                          "Percentagem de Massa Gorda" = "PBF")),),
                            mainPanel(textOutput("selected_sexo2"),
                                      textOutput("selected_desporto"),
                                      textOutput("selected_variavel"),
                                      plotOutput("plot6"),))),
                 )
